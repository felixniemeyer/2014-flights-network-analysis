...
Then, for each airport we calculate 

\begin{equation}
\begin{aligned}
& flow_{pql}' = flow_{abo} \\
& \displaystyle\sum_{a \in A | ab \in E \lor ba \in E} 
\end{aligned}
\end{equation}
...
The complete algorithm for passenger flow estimation is too long for being included in this document. You can find it in the repository: ./scripts/estimate-passenger-flows.py
