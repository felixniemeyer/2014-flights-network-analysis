...
We construct a measure that captures this welfare gain for a potential merge of two airlines $l$ and $m$. 

For both airports, we first caculate the sum of supported length-2 flights weighted by the "popularity" of the two connected airports, as the welfare gain scales with the demand for this connection. 

\begin{equation}
L2Largeness(airline) = \sum{
\end{equation}
